                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6 col-12">
                                                            <strong>Uploaded Image</strong>
                                                                <img id="uploaded_current_artwork" src="" width="150px" alt="Thumbnail" style="display:none;">
                                                              @if (!empty($release->thumbnail_path))
                                                                        <img id="existing-thumbnail" src="{{ asset('storage/' . $release->thumbnail_path) }}" width="150px" alt="Thumbnail" >
                                                                   
                                                              @endif
                                                        </div>
                                                        <div class="col-12"> <a href="{{route('releases.step2',['release_id'=>$release->id, 'level'=>'uploadtrack'])}}" class="btn btn-primary mt-3">Next</a></div>
                                                    </div>
                                                </div>
                                        </div>
                                </div>
                     ...
                     <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mt-5">
                                <div class="col-2">
                                <div class="col-12"> <a href="{{route('releases.step2',['release_id'=>$release->id, 'level'=>'edittrack'])}}" class="btn btn-primary mt-3">Next</a></div>
                                </div>
