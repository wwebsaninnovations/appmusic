        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                    <form action="{{ route('musics.editStep2.update') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <img src="{{asset($music->thumbnail_path)}}" width="100px" />
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="trackCode" name="trackCode" value="{{$music->track_code}}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control" id="releaseDate" name="releaseDate" value="{{$music->release_date}}">
                        </div>
                        ...
                        <a href="{{ route('musics.editStep1',$music->id) }}" class="btn btn-secondary">Previous</a>
